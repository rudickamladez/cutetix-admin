...
export class UpdateService {
  ...
  constructor() {
    this.#updates.versionUpdates.pipe(filter(e => e.type === "VERSION_DETECTED")).subscribe(() => {
    ...
    this.#updates.versionUpdates.pipe(filter(e => e.type === "VERSION_READY")).subscribe(async () => {
      try {
