...
export class MenuBuilder {
  ...
  build(): MenuItem[] {
    return [
      this.getMenuItem("Tickets", "tickets", faTicket, () =>
        this.getTicketsSubItems()
      ),
      this.getMenuItem("Ticket groups", "ticket_groups", faClock, () =>
        this.getSubItemsByPath("ticket_groups")
      ),
